...
public class AllVO {
	...
	private String MOD_INFO_MAN;
	private String MOD_INFO_DATE;
	...
	public String getMOD_INFO_MAN() {
		return MOD_INFO_MAN;
	}
	public void setMOD_INFO_MAN(String mOD_INFO_MAN) {
		MOD_INFO_MAN = mOD_INFO_MAN;
	}
	public String getMOD_INFO_DATE() {
		return MOD_INFO_DATE;
	}
	public void setMOD_INFO_DATE(String mOD_INFO_DATE) {
